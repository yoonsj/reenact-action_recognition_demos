...
path1 = 'C:\\Users\\yoonsj\\PycharmProjects\\Demo\\human_action_recognition\\input_data'  # path of folder of images
path2 = 'C:\\Users\\yoonsj\\PycharmProjects\\Demo\\human_action_recognition\\input_data_resized'  # path of folder to save images
...
# Rearxrange dimension so we can plot the result
